...
// TODO
// 1. Подобрать наиболее удачные параметры для записи форматов (TextPainter)
...
// 2. GPU вычисления?
// 3. Сделать подгон symbolToPixelArea под формат видео / изображения, пофиксит кривой размер выходного результата
...
// с соотношеним 4:3
// 4. научиться создавать виртуальную камеру, вроде можно через direct show driver (win)
// 5. прикрутить функционал подгрузки видоса из ютуба (yt-dlp)
