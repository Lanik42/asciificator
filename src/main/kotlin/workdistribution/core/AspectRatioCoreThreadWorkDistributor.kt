...
class AspectRatioCoreThreadWorkDistributor(
    private val xSymbolToPixelAreaRatio: Int,
    private val ySymbolToPixelAreaRatio: Int,
    imageSize: CustomSize
) {

    private val extraBottomSymbols = imageSize.height % ySymbolToPixelAreaRatio
    private val symbolsPerYDimension = imageSize.height / ySymbolToPixelAreaRatio
        ...
        for (y in 0..lastYAreaIndex) {
            if (y == lastYAreaIndex) {
                rowData[y] = ThreadInputData(
                    ...
                    symbolSizeInPixels = CustomSize(
                        xSymbolToPixelAreaRatio,
                        ySymbolToPixelAreaRatio
                    ),
            ...
            rowData[y] = ThreadInputData(
                threadHeightInSymbols = threadHeightInSymbols,
                symbolSizeInPixels = CustomSize(xSymbolToPixelAreaRatio, ySymbolToPixelAreaRatio),
            )
        }
    }
